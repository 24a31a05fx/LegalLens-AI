...
LegalLens AI is an AI-powered legal document assistant that helps people
...
LegalLens AI provides legal information and document assistance. It does not
...
├─ 03_UIUX_Design.md          Interface and accessibility requirements
├─ 04_App_Flow.md             User and processing flows
├─ 05_Backend_Schema.md       Data model and schema design
└─ 06_Implementation_Plan.md  Delivery and implementation plan
```
...
```powershell
$env:DATABASE_URL = "postgresql://legallens:legallens@localhost:5432/legallens_ai"
npm run migrate
```
...
- [01_PRD.md](./01_PRD.md): product goals, users, use cases, and requirements.
- [02_TRD.md](./02_TRD.md): architecture, security, AI provider interfaces,
  retrieval, and operational requirements.
- [03_UIUX_Design.md](./03_UIUX_Design.md): interface patterns,
  accessibility, content hierarchy, and visual rules.
- [04_App_Flow.md](./04_App_Flow.md): user journeys and processing states.
- [05_Backend_Schema.md](./05_Backend_Schema.md): entities, relationships,
  statuses, and persistence design.
- [06_Implementation_Plan.md](./06_Implementation_Plan.md): implementation
...
deploying the application. LegalLens AI is an informational document
