...
import {
  ...
  sanitizePromptText,
} from '@legallens/security';
import { Message, MessageCitation, MessageStatus } from '@legallens/shared-types';
...
export async function askQuestion(params: AskQuestionParams): Promise<AskQuestionResult> {
  ...
  if (highStakes) {
    ...
    assistantContent =
      'Important Notice: LegalLens provides informational analysis and cannot give a legal opinion, outcome prediction, or advise whether you should sign. ' +
