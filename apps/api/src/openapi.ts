export const openApiSpec = {
  ...
  info: {
    ...
    version: '1.0.0',
    description:
      'API specification for LegalLens AI — an AI-powered legal document assistant providing information, explanation, and organization grounded in user documents.',
  },
  servers: [
    {
