...
describe('Phase 4: Document Analysis & Mandatory Citation Validation (06_Implementation_Plan.md §6)', () => {
  ...
  beforeEach(async () => {
    ...
    const resA = await request(app)
      ...
      .send({ email: 'owner@legallens.internal', password: 'Password123!', displayName: 'Doc Owner' });
...
`;
    ...
    const resB = await request(app)
      .post('/api/v1/auth/signup')
      .send({ email: 'outsider@legallens.internal', password: 'Password123!', displayName: 'Outsider' });
