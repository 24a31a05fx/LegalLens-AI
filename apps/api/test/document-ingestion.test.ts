...
describe('Phase 2 & 3: Secure Document Ingestion & RAG (06_Implementation_Plan.md §4 & §5)', () => {
  ...
  beforeEach(async () => {
    ...
    const resA = await request(app)
      ...
      .send({ email: 'usera@legallens.internal', password: 'Password123!', displayName: 'User A' });
    ...
    const resB = await request(app)
      .post('/api/v1/auth/signup')
      .send({ email: 'userb@legallens.internal', password: 'Password123!', displayName: 'User B' });
