...
import { ComparisonChange, ComparisonChangeCitation } from '@legallens/shared-types';
...
describe('Phase 6: Contract Comparison & Dual-Source Grounding (06_Implementation_Plan.md §8)', () => {
  ...
  beforeEach(async () => {
    ...
    const resA = await request(app)
      ...
      .send({ email: 'lawyer@legallens.internal', password: 'Password123!', displayName: 'Reviewer' });
...
`;
    ...
    const resB = await request(app)
      .post('/api/v1/auth/signup')
      .send({ email: 'stranger@legallens.internal', password: 'Password123!', displayName: 'Stranger' });
