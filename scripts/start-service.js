...
if (service === 'api') {
  console.log(`[LegalLens AI] Starting dedicated API service on port ${publicPort}...`);
  ...
  console.log(`[LegalLens AI] Starting dedicated Next.js Web service on port ${publicPort}...`);
  ...
  console.log('[LegalLens AI] Starting dedicated Document Processing Worker...');
  ...
  console.log('========================================================');
  console.log('[LegalLens AI] Launching Unified Full-Stack Service');
  ...
  const cleanup = () => {
    console.log('[LegalLens AI] Shutting down services gracefully...');
    try {
