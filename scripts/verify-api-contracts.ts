...
async function run() {
  console.log('====================================================');
  console.log('LegalLens AI — API Contract & Security Checks');
  console.log('====================================================\n');

  // Setup: Create 2 independent users and projects for cross-tenant testing
  const userAEmail = `contract_userA_${Date.now()}@legallens.internal`;
  const userBEmail = `contract_userB_${Date.now()}@legallens.internal`;
